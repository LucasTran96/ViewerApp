...
import static com.scp.viewer.API.APIMethod.formatMilliSecond;
...
public class AdapterPhoneCallRecordHistory extends RecyclerView.Adapter<AdapterPhoneCallRecordHistory.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            ((com.scp.viewer.View.PhoneCallRecordHistory) mActivity).prepareToolbar(getAdapterPosition());
            return true;
        }
        ...
        public void onClick(View view) {
            ...
            if (com.scp.viewer.View.PhoneCallRecordHistory.isInActionMode) {
                ((com.scp.viewer.View.PhoneCallRecordHistory) mActivity).prepareSelection(getAdapterPosition());
            ...
            } else if (position != RecyclerView.NO_POSITION)
            {
                ...
                if (PhoneCallRecordHistory.request) {
                    ...
                    if (phoneCallRecord.getIsSave() == 1) {
                        ...
                        if(file.exists())
                        {
                            Log.d("check","file exits");
                            playAudio();

                        }
                        else
                        {
                            Log.d("check","file not exits"+ " === "+filePath );
                    ...
                    dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public void onDismiss(DialogInterface dialogInterface) {
                            ...
                            ((com.scp.viewer.View.PhoneCallRecordHistory) mActivity).reload();
                        }
                    });
                } else {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(phoneCallRecord != null)
        {
            ...
            if(phoneCallRecord.getIsAmbient() == 1)
                ...
                holder.txt_time_PhoneCallRecord_History.setText(formatMilliSecond(Long.parseLong(phoneCallRecord.getDuration())*1000)+"s");
            ...
            if (com.scp.viewer.View.PhoneCallRecordHistory.isInActionMode) {
                if (com.scp.viewer.View.PhoneCallRecordHistory.selectionList.contains(mData.get(position))) {
