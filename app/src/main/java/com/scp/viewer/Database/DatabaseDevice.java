...
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_APP_VERSION_NUMBER;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_BATTERY;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_BRAND_ID;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_ID;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_COUNTRY;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_CREATED_BY;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_CREATED_DATE;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_LAST_ONLINE;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_WIFI_ENABLED;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_Device_ID;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_DEVICE_NAME;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_DEVICE_TOKEN;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_GPS_OPTION_TURNED;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_ICCID;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_IMEI;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_IMSI;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_IS_ROOTED_OR_JAILBROKEN;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_LOGIN_NAME;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_MODIFIED_BY;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_MODIFIED_DATE;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_OS_DEVICE;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_PHONE_NUMBER;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_SIM_CARD_INFO;
import static com.scp.viewer.Database.Entity.ManagementDeviceEntity.COLUMN_STATUS_MESSAGE;
    ...
    public ArrayList<Table> getAllDevice() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                table.setDevice_Identifier(cursor.getString(2));
