...
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_CREATED_DATE_USER;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_EXPIRY_DATE;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_ID_USERINFO;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_LAST_IP_ACCESS;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_LAST_TIME_ACCESS;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_LOGIN_NAME_USER;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_MAX_DEVICE;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_MODIFIED_DATE;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_NICK_NAME;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_PACKAGE_ID;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_PASSWORD_USER;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_STATUS;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_TIME_ZONE_ID;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_TRACKING_LEVEL;
import static com.scp.viewer.Database.Entity.UserEntity.COLUMN_USER_TYPE;
...
public class DatabaseUserInfo
{
    ...
    public void createTable() {
        ...
        String scriptTable = "CREATE TABLE " + TABLE_USER_INFO + "("
                + COLUMN_ID_USERINFO + " LONG PRIMARY KEY,"
                + COLUMN_LOGIN_NAME_USER + " TEXT,"
                + COLUMN_PASSWORD_USER + " TEXT,"
                + COLUMN_EXPIRY_DATE + " TEXT,"
                + COLUMN_STATUS + " TEXT,"
                + COLUMN_CREATED_DATE_USER + " TEXT,"
                + COLUMN_MODIFIED_DATE + " TEXT,"
                + COLUMN_USER_TYPE + " TEXT,"
                + COLUMN_NICK_NAME + " TEXT,"
                + COLUMN_MAX_DEVICE + " TEXT,"
                + COLUMN_PACKAGE_ID + " TEXT,"
                + COLUMN_TRACKING_LEVEL + " TEXT,"
                + COLUMN_LAST_IP_ACCESS + " TEXT,"
                + COLUMN_LAST_TIME_ACCESS + " TEXT,"
                + COLUMN_TIME_ZONE_ID + " TEXT" + ")";
    ...
    public List<AccountInFo> getAllUserInfo() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                accountInFo.setLogin_Code(cursor.getString(1));
                ...
                accountInFo.setPackage_Name(cursor.getString(10));
    ...
    public void deleteUserInfo(AccountInFo accountInFo) {
        Log.i(TAG, "DatabaseUser.updateNote ... " + accountInFo.getLogin_Code());
