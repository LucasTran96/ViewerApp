...
public class ApplicationUsageHistory extends AppCompatActivity {
    ...
    private void getAppUsageInfo() {
        ...
        if (isConnected(this)) {
            ...
            int i = database_application_usage.get_ApplicationCount_DeviceID(table.getID());
            if (i == 0) {
                ...
                txt_Total_Data.setText(getSharedPreferLong(getApplicationContext(), APP_USAGE_TOTAL + table.getDevice_Identifier())+"");
            }
        }
    }
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run()
                {
                    ...
                    if(isConnected(getApplicationContext()))
                    {
                        ...
                        long totalContact = getSharedPreferLong(getApplicationContext(), APP_USAGE_TOTAL + table.getDevice_Identifier());
                        ...
                        List<ApplicationUsage> mDataCall = database_application_usage.getAll_Application_ID_History(table.getID(),currentSize);
                        // Here is the total item value contact of device current has on Cpanel
    ...
    private class getAppAsyncTask extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                setToTalLog(GPSJsonTable1, APP_USAGE_TOTAL + table.getDevice_Identifier(), getApplicationContext());
                setSharedPreferLong(getApplicationContext(), APP_USAGE_PULL_ROW +_TOTAL+ table.getDevice_Identifier() + NEW_ROW, 0);
