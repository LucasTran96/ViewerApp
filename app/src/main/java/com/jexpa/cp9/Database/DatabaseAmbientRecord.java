...
import static com.jexpa.cp9.API.APIMethod.checkItemExistString;
import static com.jexpa.cp9.API.APIMethod.checkItemExistWithDeviceIDString;
...
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_AUDIO_NAME_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_AUDIO_SIZE_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_CDN_URL_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_CREATED_DATE_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_DEVICE_ID_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_DURATION_AMBIENTRECORD;
import static com.jexpa.cp9.Database.Entity.AmbientRecordEntity.COLUMN_ISSAVED_AMBIENTRECORD;
...
import static com.jexpa.cp9.View.PhoneCallRecordHistory.deleteFileAudioWithName;
            ...
            for (int i = 0; i < ambientRecordsList.size(); i++)
            {
                if(!ambientRecordsList.get(i).getFileName().contains("_"))
                {
                    ...
                    if(!timeOld.equals(""))
                    {
                        ...
                        {
                            try {
                                Log.d("textAaa", "Date = "+ ambientRecordsList.get(i).getDate() + " Vào timeOld");
                                // delete record
