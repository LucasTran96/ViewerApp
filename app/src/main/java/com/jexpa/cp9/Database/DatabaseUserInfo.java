...
import com.jexpa.cp9.Model.AccountInFo;
...
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_CREATED_DATE_USER;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_EXPIRY_DATE;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_ID_USERINFO;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_LAST_IP_ACCESS;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_LAST_TIME_ACCESS;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_LOGIN_NAME_USER;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_MAX_DEVICE;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_MODIFIED_DATE;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_NICK_NAME;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_PACKAGE_ID;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_PASSWORD_USER;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_STATUS;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_TIME_ZONE_ID;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_TRACKING_LEVEL;
import static com.jexpa.cp9.Database.Entity.UserEntity.COLUMN_USER_TYPE;
