...
import com.jexpa.cp9.Model.Photo;
...
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_CAPTION_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_CDN_URL_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_CLIENT_CAPTURED_DATE_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_CREATED_DATE_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_DEVICE_ID_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_EXT_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_FILE_NAME_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_ID_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_ISLOADED_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_MEDIA_URL_PHOTO;
import static com.jexpa.cp9.Database.Entity.PhotoHistoryEntity.COLUMN_ROWINDEX_PHOTO;
...
public class DatabasePhotos {
    ...
    public List<Photo> getAll_Photo_ID_Position_History(String deviceID) {

        Log.i(TAG, "DatabasePhotos.getAll_Photo... " + TABLE_PHOTO_HISTORY);

        List<Photo> photos_List = new ArrayList<>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_PHOTO_HISTORY +" WHERE Device_ID = '"+deviceID+ "' ORDER BY " + COLUMN_CLIENT_CAPTURED_DATE_PHOTO ;
        //SQLiteDatabase database = this.getWritableDatabase();
