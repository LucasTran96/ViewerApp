...
public class URLEntity {
    ...
    public static final String DATABASE_NAME_URL_HISTORY = "URLManager";
    public static final int DATABASE_VERSION_URL_HISTORY = 1;
    public static final String COLUMN_ROWINDEX_URL = "RowIndex";
