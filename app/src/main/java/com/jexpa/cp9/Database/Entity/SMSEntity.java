...
public class SMSEntity {
    ...
    public static final String DATABASE_NAME_SMS = "SMSManager";
    public static final int DATABASE_VERSION_SMS = 1;
    ...
    public static final String COLUMN_CREATED_DATE_SMS = "Created_Date1";
}
