...
import com.jexpa.cp9.View.CallHistoryDetail;
...
import static com.jexpa.cp9.API.APIMethod.setDateForArrayList;
import static com.jexpa.cp9.API.Global.DEFAULT_DATE_FORMAT_MMM;
import static com.jexpa.cp9.API.Global.DEFAULT_TIME_FORMAT_AM;
...
public class AdapterCallHistory extends RecyclerView.Adapter<AdapterCallHistory.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            ((com.jexpa.cp9.View.CallHistory) mActivity).prepareToolbar(getAdapterPosition());
            return true;
        }
        ...
        public void onClick(View view) {
            ...
            if (com.jexpa.cp9.View.CallHistory.isInActionMode) {

                ((com.jexpa.cp9.View.CallHistory) mActivity).prepareSelection(getAdapterPosition());
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(call != null)
        {
            ...
            if (com.jexpa.cp9.View.CallHistory.isInActionMode) {
                if (com.jexpa.cp9.View.CallHistory.selectionList.contains(mDataSet.get(position))) {
