...
import com.jexpa.cp9.Database.DatabaseAmbientRecord;
import com.jexpa.cp9.Database.DatabasePhoneCallRecord;
...
import static com.jexpa.cp9.API.APIMethod.formateMilliSeccond;
import static com.jexpa.cp9.API.APIURL.isConnected;
import static com.jexpa.cp9.API.Global.File_PATH_SAVE_PHONE_CALL_RECORD;
...
public class AdapterPhoneCallRecordHistory extends RecyclerView.Adapter<AdapterPhoneCallRecordHistory.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            ((com.jexpa.cp9.View.PhoneCallRecordHistory) mActivity).prepareToolbar(getAdapterPosition());
            return true;
        }
        ...
        public void onClick(View view) {
            ...
            if (com.jexpa.cp9.View.PhoneCallRecordHistory.isInActionMode) {
                ((com.jexpa.cp9.View.PhoneCallRecordHistory) mActivity).prepareSelection(getAdapterPosition());
                ...
                if (PhoneCallRecordHistory.request) {
                    ...
                    dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public void onDismiss(DialogInterface dialogInterface) {
                            ...
                            ((com.jexpa.cp9.View.PhoneCallRecordHistory) mActivity).reload();
                        }
                    });
                } else {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(phoneCallRecord != null)
        {
            ...
            if (com.jexpa.cp9.View.PhoneCallRecordHistory.isInActionMode) {
                if (com.jexpa.cp9.View.PhoneCallRecordHistory.selectionList.contains(mData.get(position))) {
