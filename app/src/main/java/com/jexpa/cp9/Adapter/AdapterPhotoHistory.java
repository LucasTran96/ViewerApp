...
import com.jexpa.cp9.View.PhotoHistoryDetail;
...
public class AdapterPhotoHistory extends RecyclerView.Adapter<AdapterPhotoHistory.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(photo != null)
        {
            ...
            if (com.jexpa.cp9.View.PhotoHistory.isInActionMode)
            {
                //holder.checkBox_photo.setVisibility(View.VISIBLE);
                if (com.jexpa.cp9.View.PhotoHistory.selectionList.contains(photoList.get(position))) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View view) {
            ...
            if (com.jexpa.cp9.View.PhotoHistory.isInActionMode)
            {
                ((com.jexpa.cp9.View.PhotoHistory)mActivity).prepareSelection(getAdapterPosition());
        ...
        public boolean onLongClick(View view) {
            ((com.jexpa.cp9.View.PhotoHistory)mActivity).prepareToolbar(getAdapterPosition());
            return true;
        }
    }
