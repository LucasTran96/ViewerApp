...
import com.jexpa.cp9.Adapter.AdapterPhotoHistory;
import com.jexpa.cp9.Database.DatabaseLastUpdate;
import com.jexpa.cp9.Database.DatabasePhotos;
import com.jexpa.cp9.Model.Photo;
import com.jexpa.cp9.Model.PhotoJson;
...
import static com.jexpa.cp9.API.Global.File_PATH_SAVE_IMAGE;
...
import static com.jexpa.cp9.Adapter.AdapterPhotoHistory.positionLastSelected;
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if(isConnected(getApplicationContext()))
                    {
                        ...
                        List<Photo> mDataCall = databasePhotos.getAll_Photo_ID_History(table.getDevice_ID(),currentSize,true,NumberLoad);
                        // Here is the total item value contact of device current has on Cpanel
    ...
    private void getPhotoHistoryInfo() {
        ...
        if (isConnected(this)) {
            ...
            if (i == 0) {
                ...
                mData.clear();
                mData = databasePhotos.getAll_Photo_ID_History(table.getDevice_ID(),0, true,NumberLoad);
    ...
    private class getPhotoAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                List<Photo> mDataTamp = databasePhotos.getAll_Photo_ID_History(table.getDevice_ID(),currentSize, false,NumberLoad);
...
//        }
                    ...
                    if(selectionList.size() <= 5)
                    {
                        ...
                        /*for (Photo photo : selectionList)
                        {
                            ...
                            if (photo.getIsLoaded() == 0) {
                                ...
                                saveImage(fileName, CDN_URL, Media_URL, 1, Device_ID, ID, position_Image);
                                }
                        }*/
     ...
     */
    public void clearDataSQLite(ArrayList<com.jexpa.cp9.Model.Photo> selectionList) {
        for (com.jexpa.cp9.Model.Photo photo : selectionList) {
     ...
     */
    public void clearFileImage(ArrayList<com.jexpa.cp9.Model.Photo> selectionList) {
        for (com.jexpa.cp9.Model.Photo photo : selectionList) {
